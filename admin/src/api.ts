...
export type RoomType = { id: string; name: string; description: string | null; capacityAdults: number; capacityChildren: number; maxExtraBeds: number; basePrice: Money; weeklyPrice: Money | null; monthlyPrice: Money | null; amenities: string[]; _count?: { rooms: number } };
...
export type AvailUnit = { roomTypeId: string; name: string; description: string | null; amenities: string[]; unit: "room" | "bed"; freeUnits: number; capacityAdults: number; capacityChildren: number; maxExtraBeds: number; extraBedsNeeded: number; roomTotal: Money; cityTax: Money; total: Money };
