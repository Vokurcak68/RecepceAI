...
export type AresResult = { ico: string; name: string | null; dic: string | null; street: string | null; city: string | null; zip: string | null; country: string; vatPayer: boolean; viesValid: boolean | null; found: boolean };
