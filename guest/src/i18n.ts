...
const cs: Dict = {
  ...
  dndTitle: "Nerušit", dndHint: "Pokud si nepřejete úklid pokoje, zapněte Nerušit. Personál vás nebude rušit.", dndOn: "🚫 Nerušit je zapnuto – klepnutím vypnete", dndOff: "Zapnout Nerušit",
...
const en: Dict = {
  ...
  dndTitle: "Do not disturb", dndHint: "If you don't want your room cleaned, turn on Do Not Disturb. Staff won't disturb you.", dndOn: "🚫 Do Not Disturb is on – tap to turn off", dndOff: "Turn on Do Not Disturb",
...
const de: Dict = {
  ...
  dndTitle: "Nicht stören", dndHint: "Wenn Sie keine Zimmerreinigung wünschen, aktivieren Sie 'Nicht stören'. Das Personal stört Sie nicht.", dndOn: "🚫 'Nicht stören' ist aktiv – zum Ausschalten tippen", dndOff: "'Nicht stören' aktivieren",
...
const ru: Dict = {
  ...
  dndTitle: "Не беспокоить", dndHint: "Если не хотите уборку номера, включите «Не беспокоить». Персонал не будет вас беспокоить.", dndOn: "🚫 «Не беспокоить» включено – нажмите, чтобы выключить", dndOff: "Включить «Не беспокоить»",
...
const uk: Dict = {
  ...
  dndTitle: "Не турбувати", dndHint: "Якщо не бажаєте прибирання номера, увімкніть «Не турбувати». Персонал вас не турбуватиме.", dndOn: "🚫 «Не турбувати» увімкнено – натисніть, щоб вимкнути", dndOff: "Увімкнути «Не турбувати»",
...
const pl: Dict = {
  ...
  dndTitle: "Nie przeszkadzać", dndHint: "Jeśli nie chcesz sprzątania pokoju, włącz 'Nie przeszkadzać'. Personel nie będzie przeszkadzać.", dndOn: "🚫 'Nie przeszkadzać' włączone – dotknij, aby wyłączyć", dndOff: "Włącz 'Nie przeszkadzać'",
...
const sk: Dict = {
  ...
  dndTitle: "Nerušiť", dndHint: "Ak si neželáte upratovanie izby, zapnite 'Nerušiť'. Personál vás nebude rušiť.", dndOn: "🚫 'Nerušiť' je zapnuté – ťuknutím vypnete", dndOff: "Zapnúť 'Nerušiť'",
...
const it: Dict = {
  ...
  dndTitle: "Non disturbare", dndHint: "Se non desideri la pulizia della camera, attiva 'Non disturbare'. Il personale non ti disturberà.", dndOn: "🚫 'Non disturbare' attivo – tocca per disattivare", dndOff: "Attiva 'Non disturbare'",
...
const fr: Dict = {
  ...
  dndTitle: "Ne pas déranger", dndHint: "Si vous ne souhaitez pas le ménage, activez 'Ne pas déranger'. Le personnel ne vous dérangera pas.", dndOn: "🚫 'Ne pas déranger' activé – appuyez pour désactiver", dndOff: "Activer 'Ne pas déranger'",
...
const es: Dict = {
  ...
  dndTitle: "No molestar", dndHint: "Si no desea limpieza de la habitación, active 'No molestar'. El personal no le molestará.", dndOn: "🚫 'No molestar' activado – toque para desactivar", dndOff: "Activar 'No molestar'",
...
const zh: Dict = {
  ...
  dndTitle: "请勿打扰", dndHint: "如果您不需要客房清洁，请开启「请勿打扰」。工作人员不会打扰您。", dndOn: "🚫 「请勿打扰」已开启 – 点按关闭", dndOff: "开启「请勿打扰」",
