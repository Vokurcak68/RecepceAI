...
const cs: Dict = {
  ...
  ocDocId: "Občanský průkaz", ocDocPassport: "Cestovní pas", ocDocNum: "Číslo dokladu", ocAddress: "Adresa trvalého bydliště", ocPerson: "Osoba",
...
const en: Dict = {
  ...
  ocDocId: "ID card", ocDocPassport: "Passport", ocDocNum: "Document number", ocAddress: "Home address", ocPerson: "Guest",
...
const de: Dict = {
  ...
  ocDocId: "Personalausweis", ocDocPassport: "Reisepass", ocDocNum: "Dokumentnummer", ocAddress: "Wohnadresse", ocPerson: "Person",
...
const ru: Dict = {
  ...
  ocDocId: "Удостоверение личности", ocDocPassport: "Паспорт", ocDocNum: "Номер документа", ocAddress: "Домашний адрес", ocPerson: "Гость",
...
const uk: Dict = {
  ...
  ocDocId: "Посвідчення особи", ocDocPassport: "Паспорт", ocDocNum: "Номер документа", ocAddress: "Домашня адреса", ocPerson: "Гість",
...
const pl: Dict = {
  ...
  ocDocId: "Dowód osobisty", ocDocPassport: "Paszport", ocDocNum: "Numer dokumentu", ocAddress: "Adres zamieszkania", ocPerson: "Osoba",
...
const sk: Dict = {
  ...
  ocDocId: "Občiansky preukaz", ocDocPassport: "Cestovný pas", ocDocNum: "Číslo dokladu", ocAddress: "Adresa trvalého bydliska", ocPerson: "Osoba",
...
const it: Dict = {
  ...
  ocDocId: "Carta d'identità", ocDocPassport: "Passaporto", ocDocNum: "Numero documento", ocAddress: "Indirizzo di residenza", ocPerson: "Ospite",
...
const fr: Dict = {
  ...
  ocDocId: "Carte d'identité", ocDocPassport: "Passeport", ocDocNum: "Numéro du document", ocAddress: "Adresse du domicile", ocPerson: "Personne",
...
const es: Dict = {
  ...
  ocDocId: "DNI", ocDocPassport: "Pasaporte", ocDocNum: "Número de documento", ocAddress: "Domicilio", ocPerson: "Huésped",
...
const zh: Dict = {
  ...
  ocDocId: "身份证", ocDocPassport: "护照", ocDocNum: "证件号码", ocAddress: "家庭住址", ocPerson: "客人",
